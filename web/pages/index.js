...
export default function Home() {
  ...
  const connectToPolygon = async () => {
    console.log('activate 2', chainId, active, activate)
    // console.log('activate', await activate(process.env.NEXT_PUBLIC_ACCEPTED_CHAIN_ID))
  }
  ...
  return (
    <Container sx={{minHeight: '100vh', margin: 0, 'minWidth': '100%', marginBottom: '100px'}}
      style={{padding: 0}}>
      <Head id="home">
        <title>Mint NFTs - Furry Fox Woodside Club</title>
